                    ...
                    <div className="nav__logo">
                        <Link to={withPrefix('/')}>
                            {(white_header || (_.get(page, 'frontmatter.template', null) === 'product')) ? (
                                <Picture {...this.props} image={_.get(site, 'siteMetadata.logo_light', null)} cssClass={'nav__logo-image'} alt={'Planty logo'} />
                            ) : 
                                <Picture {...this.props} image={_.get(site, 'siteMetadata.logo_dark', null)} cssClass={'nav__logo-image'} alt={'Planty logo'} />
                            }
                        </Link>
                    </div>
