...
export default class HeaderSection extends React.Component {
    render() {
        ...
        return (
            <section className="content__row header-section__header"  style={toStyleObj('background-image: url(' + withPrefix(_.get(section, 'background_image', null)) + ')')}  data-id={_.get(section, 'section_id', null)}>
